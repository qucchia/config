...
This keyboard configuration uses =xmodmap=. See https://wiki.archlinux.org/title/xmodmap for documentation on Xmodmap.
...
#+begin_src conf
  ...
  keycode  25 =            w          W NoSymbol NoSymbol    bracketleft  braceleft
