...
filetype plugin indent on   " allow file-specific plugins and indenting
...
" Currently disabled because overrides <tab>
...
set showcmd                 " show incomplete commands left to the ruler
set hidden                  " keep abandoned(?) buffers
